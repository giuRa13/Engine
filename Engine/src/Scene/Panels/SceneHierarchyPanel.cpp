...
namespace ENGINE
{
	...
	void SceneHierarchyPanel::DrawEntityNode(Entity entity)
	{
		...
		ImGuiTreeNodeFlags flags = ((m_SelectionContext == entity) ? ImGuiTreeNodeFlags_Selected : 0) | ImGuiTreeNodeFlags_OpenOnArrow | ImGuiTreeNodeFlags_Framed;
		...
		DrawComponent<SpriteRendererComponent>("Sprite Renderer", entity, [](auto& component)
			{
				...
				ImGui::Button("Load Texture", ImVec2(100.0f, 100.0f));
				if (ImGui::BeginDragDropTarget())
				{
					if (const ImGuiPayload* payload = ImGui::AcceptDragDropPayload("CONTENT_BROWSER_ITEM"))
					{
						...
						if (texture->IsLoaded())
							...
							ENGINE_APP_WARN("Could not load texture {0}", texturePath.filename().string());
					}
